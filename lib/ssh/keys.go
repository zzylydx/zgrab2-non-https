...
import (
	...
	ztoolsX509 "github.com/zzylydx/zcrypto/x509"
	ztoolsKeys "github.com/zzylydx/zgrab2/tools/keys"
)
...
func (r *rsaPublicKey) Marshal() []byte {
	...
	// parseRSACert in the github.com/zzylydx/zgrab2/lib/agent package.
	wirekey := struct {
		Name string
		E    *big.Int
		N    *big.Int
...
func (k *dsaPublicKey) Marshal() []byte {
	...
	// parseDSACert in the x/github.com/zzylydx/zgrab2/lib/agent package.
	w := struct {
		Name       string
		P, Q, G, Y *big.Int
	}{
...
func (key *ecdsaPublicKey) Marshal() []byte {
	...
	// parseECDSACert in the github.com/zzylydx/zgrab2/lib/agent package.
	w := struct {
		Name string
		ID   string
		Key  []byte
